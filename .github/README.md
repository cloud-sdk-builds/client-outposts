...
[`@aws-sdk/client-outposts`](https://www.npmjs.com/package/@aws-sdk/client-outposts/v/3.289.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-outposts@3.289.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pmbzoGMlGYjnPHMlztb3h+EG5F/Toz2WaGKn6AfJwTBtq4M7dPgzIueMHbuGmFb+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-outposts": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-outposts@3.289.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-outposts@3.289.0/index.min.mjs": "sha384-pmbzoGMlGYjnPHMlztb3h+EG5F/Toz2WaGKn6AfJwTBtq4M7dPgzIueMHbuGmFb+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-outposts/blob/refs/tags/3.289.0/LICENSE
```
